...
class DuctilityPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        main1 = tk.Label(self, font=('25'), text="DUCTILITY STRENGTH", width=40, fg='BLUE', bg='lightblue')
        main1.grid(row=0, column=0, columnspan=2, padx=10,pady=10, sticky='we')
        ...
        self.num1Entry.grid(row=1, column=1, padx=10,pady=10)
        ...
        self.num2Entry.grid(row=2, column=1,padx=10,pady=10)
        ...
        self.num3Entry.grid(row=3, column=1,padx=10,pady=10)
